...
bool secrets_load() {
    ...
    strlcpy(g_secrets.llm_host,   doc["llm_host"]   | "", sizeof(g_secrets.llm_host));
    strlcpy(g_secrets.llm_port,   doc["llm_port"]   | "7123", sizeof(g_secrets.llm_port));
    ...
    Serial.printf("Secrets: loaded (ssid=%s stt=%s:%s tts=%s:%s)\n",
                  g_secrets.wifi_ssid, g_secrets.stt_host, g_secrets.stt_port,
